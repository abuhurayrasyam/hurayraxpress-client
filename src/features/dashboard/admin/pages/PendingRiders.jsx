        ...
        <div className="p-6">
            ...
            {riders.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-20 text-gray-500 space-y-3">
                    <FaEye className="text-6xl animate-pulse" />
                    <p className="text-lg font-semibold">No pending rider requests found</p>
                    <p className="max-w-md text-center">Looks like there are no new rider applications at the moment. Check back later!</p>
                </div>
            ) : (
                <>
