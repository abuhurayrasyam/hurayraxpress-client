...
import { FaBoxOpen, FaHome, FaMoneyCheckAlt, FaMotorcycle, FaSearchLocation, FaUserEdit, FaUserPlus, FaUserShield, FaUserSlash } from 'react-icons/fa';
        ...
        <>
            ...
            <NavLink to="/dashboard/be-rider" className="flex text-sm md:text-xl items-center gap-2 text-white mb-2"><FaMotorcycle /> Be A Rider</NavLink>
            {
                ...
                <>
                    ...
                    <NavLink to="/dashboard/assign-rider" className="flex text-sm md:text-xl items-center gap-2 text-white mb-2"><FaUserPlus /> Assign Rider</NavLink>
